...
public class CopyOnWriteArrayList implements List, RandomAccess, Cloneable, java.io.Serializable {
  ...
  private transient Object[] array_;
  ...
  **/
  ...
  private static int indexOf(Object elem, 
                               Object[] elementData,
                               int len) {
    if (elem == null) {
      for (int i = 0; i < len; i++)
  ...
  private static int lastIndexOf(Object elem, 
                                   Object[] elementData,
                                   int len) {
    if (elem == null) {
   ...
   **/
  synchronized boolean addIfAbsent(Object element) {
  ...
  synchronized int addAllAbsent(Collection c) {
    int numNew = c.size();
  ...
  private static class COWSubList extends AbstractList {
    ...
    */
    ...
    private class COWSubListIterator implements ListIterator {
