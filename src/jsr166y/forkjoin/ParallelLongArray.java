...
public class ParallelLongArray {
     ...
     */
    public void apply(LongProcedure proc) {
     ...
     * @param proc the procedure
     */
    public void apply(LongPredicate selector,
                      LongProcedure proc) {
     ...
     * @return reduction
     */
    public long reduce(LongReducer reducer,
                       long base) {
     ...
     * @return reduction
     */
    public long reduce(LongPredicate selector,
                       LongReducer reducer,
                       long base) {
     ...
     */
    public  ParallelLongArray map(LongTransformer mapper) {
     ...
     * @return the array of mappings
     */
    public ParallelIntArray map(MapperFromLongToInt  mapper) {
        return map(0, array.length, mapper);
    }
     ...
     * @return the array of mappings
     */
    public ParallelDoubleArray map(MapperFromLongToDouble  mapper) {
        return map(0, array.length, mapper);
    }
     ...
     */
    public int indexOf(LongPredicate  pred) {
    ...
    /**
     * Returns the minimum of all elements, or Long.MAX_VALUE if empty
     * @return minimum of all elements, or Long.MAX_VALUE if empty
     */
    public long min() {
        return reduce(LongMinReducer.min, Long.MAX_VALUE);
    }
     ...
     * @return minimum of all elements, or Long.MAX_VALUE if empty
     */
    public long min(int fromIndex, int toIndex) {
        return reduce(fromIndex, toIndex, LongMinReducer.min,
                      Long.MAX_VALUE);
    }

    /**
     * Returns the maximum of all elements, or Long.MIN_VALUE if empty
     * @return maximum element, or Long.MIN_VALUE if empty
     */
    public long max() {
        return reduce(LongMaxReducer.max, Long.MIN_VALUE);
    }

    /**
     * Returns the maximum of elements from fromIndex to toIndex, or
     * Long.MIN_VALUE if empty
     * @param fromIndex (inclusive)
     * @param toIndex (exclusive)
     * @return maximum element, or Long.MIN_VALUE if empty
     */
    public long max(int fromIndex, int toIndex) {
        return reduce(fromIndex, toIndex, LongMaxReducer.max,
                      Long.MIN_VALUE);
    }
     ...
     */
    public long sum() {
        return reduce(LongAdder.adder, 0L);
    }
    ...
    public long sum(int fromIndex, int toIndex) {
        return reduce(fromIndex, toIndex, LongAdder.adder, 0L);
    }

    /**
     * Returns a ParallelLongArray mapping each element of array for
     * which the selector returns true;
     * @param selector the predicate
     * @param mapper the mapper
     * @return the array of mappings
     */
    public  ParallelLongArray map(LongPredicate selector,
                                  LongTransformer mapper) {
        int n = array.length;
        int m = ex.getParallelismLevel();
        int g = defaultGranularity(m, n);
    ...
    /**
     * Returns a ParallelLongArray mapping each element of array from
    ...
    /**
     * Returns a ParallelLongArray of all elements of the array matching
     ...
     */
    public ParallelLongArray select(LongPredicate pred) {
     ...
     * @return an array of all elements matching the predicate.
     */
    public ParallelLongArray select(int fromIndex, int toIndex,
                                    LongPredicate pred) {
        int n = rangeCheck(array.length, fromIndex, toIndex);
        int m = ex.getParallelismLevel();
        int g = defaultGranularity(m, n);
    ...
    static final class FJSelectAll extends RecursiveAction {
        ...
        void leafPhase2() {
            ...
            if (m != null) {
                int n = nmatches;
                int k = offset;
                LongTransformer mapper = this.mapper;
                if (mapper != null) {
                    for (int i = 0; i < n; ++i)
    ...
    static class FJCmpSorter extends RecursiveAction {
        ...
        FJCmpSorter(
                         long[] a, int ao, long[] w, int wo, int n) {
    ...
    static class FJCmpMerger  extends RecursiveAction {
        ...
        FJCmpMerger(long[] a, int lo, int ln, int ro, int rn, long[] w, int wo) {
            this.a = a;
            this.w = w;
            this.wo = wo;
     ...
     */
    static  void cmpArrayQuickSort(long[] a, int lo, int hi) {
        for (;;) { 
    ...
    static void seqCumulate(long[] array) {
        long sum = 0;
