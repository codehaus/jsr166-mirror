...
class LongCombineDemo {
    ...
    public static void main (String[] args) throws Exception {
        ...
        long[] b = new long[n];
        ParallelLongArray pb = ParallelLongArray.createUsingHandoff(b, fjpool);
    ...
    static class Less implements Ops.BinaryLongPredicate {
    ...
    static final Less less = new Less();
